package com.sanrist.admin.client;
...
public class MyCompanyAdminModule extends MerchandisingModule {
	...
	public void onModuleLoad() {
		...
		moduleFactory.put("product", "com.sanrist.admin.client.view.product.MyCompanyProductView");
		moduleFactory.put("productPresenter", "com.sanrist.admin.client.presenter.product.MyCompanyProductPresenter");
	}
